...
<table width="50%">
  ...
  <font color="blue">
  <a href="travel_writeForm.do">글쓰기</a>
  </font>
  </td>
  </tr>
</table>
...
<c:if test="${count>0}">
 <table width="50%" align="center">
  ...
  <td  align="center">
   ...
   <a href="travel_content.do?num=${dto.num}&pageNum=${currentPage}">
   ${dto.subject}
   </a>
  </td>
...
<a href="travel_list.do?pageNum=${startPage-10}">[이전블럭]</a>
</c:if>

<!-- 페이지 처리 -->
<c:forEach var="i" begin="${startPage}" end="${endPage}">
<a href="travel_list.do?pageNum=${i}">
[${i}]
</a>
</c:forEach>
...
<!-- 다음 블럭 -->
<c:if test="${endPage<pageCount}">
<a href="travel_list.do?pageNum=${startPage+10}">[다음블럭]</a>
</c:if>
